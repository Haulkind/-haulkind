...
export const metadata: Metadata = {
  title: 'Property Cleanout Services in PA, NY & NJ | HaulKind',
  description: 'Full property cleanout services in Pennsylvania, New York & New Jersey. Homes, apartments, garages, basements. Same-day available. Insured & affordable. Get a free quote.',
  alternates: { canonical: '/services/cleanout' },
  openGraph: {
    title: 'Property Cleanout Services | HaulKind',
    description: 'Full property cleanouts — homes, apartments, garages, basements. Fast, affordable, insured. Serving PA, NY & NJ.',
...
export default function CleanoutPage() {
  const jsonLd = {
    ...
    description: 'Full property cleanout services for homes, apartments, garages, basements, and estates. Professional, insured, and affordable.',
    provider: {
      '@type': 'LocalBusiness',
      name: 'HaulKind',
    ...
    <div className="bg-white">
      ...
      <section className="bg-primary-50 py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Property Cleanout Services in PA, NY & NJ
          </h1>
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-bold mb-6">What Is a Property Cleanout?</h2>
          <p className="text-gray-700 text-lg mb-4">
            A property cleanout means removing everything you don't want from a space — furniture, appliances, trash, personal items, yard debris, and more. It's the fastest way to reclaim a cluttered room, prepare a property for sale, or hand back a rental in clean condition.
          </p>
          <p className="text-gray-700 text-lg mb-4">
            At HaulKind, we handle cleanouts of all sizes. From a single-room apartment in Newark to a 4-bedroom house in Philadelphia, our insured professionals arrive on time, remove everything you point to, and leave the space clean. We sort items for donation, recycling, and responsible disposal so you don't have to worry about where it all goes.
          </p>
          <p className="text-gray-700 text-lg">
            Landlords, property managers, real estate agents, homeowners, and families dealing with estates all rely on HaulKind for fast, affordable cleanouts across Pennsylvania, New York, and New Jersey.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { step: '2', title: 'Schedule Your Cleanout', desc: 'Pick a date and time that works for you. Same-day service is available in most areas. We work around your schedule, not the other way around.' },
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-bold mb-8">What We Clean Out</h2>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-bold mb-8">Why Choose HaulKind for Your Cleanout</h2>
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              { title: 'Eco-Friendly Disposal', desc: 'We donate usable items and recycle what we can. Landfill is the last resort.' },
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-bold mb-6">Cleanout Service Areas</h2>
          <p className="text-gray-700 text-lg mb-6">
            HaulKind offers property cleanout services across the tri-state area. Our drivers are local, which means faster response times and lower costs for you.
          </p>
      ...
      <section className="py-16 md:py-24 bg-primary-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get your exact price in seconds. No account needed, no obligation. Fast, affordable cleanouts across PA, NY & NJ.
          </p>
          <Link
            href="/quote"
