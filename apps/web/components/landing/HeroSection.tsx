        ...
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col items-start mb-8">
            <Link
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all shadow-lg hover:shadow-xl"
            >
              Get Instant Quote
            ...
            <p className="mt-2 text-[13px] text-white/70 max-w-[340px] text-center">
              ✅ Book before noon for same-day pickup — limited slots
            </p>
          </div>
