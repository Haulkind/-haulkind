...
const services = [
  {
    ...
    description: 'Complete property clearing services from individual rooms to full estates.',
    icon: (
  ...
  },
  {
    ...
    description: 'Professional assembly and setup for furniture, fixtures, and equipment.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'Moving Labor',
    description: 'On-demand assistance for heavy lifting, loading, and furniture relocation.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Commercial cleanout for workstations, office furniture, and tech equipment.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Quick pickup and disposal of unwanted furniture, from single pieces to complete sets.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
