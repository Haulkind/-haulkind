...
export const CITIES: CityData[] = [
  ...
  },
  {
    ...
    slug: 'camden-nj',
    population: '73,000',
    description: 'Located just across the Delaware River from Philadelphia, Camden is undergoing a major revitalization. Whether you are cleaning out an older property, renovating, or just need help hauling away accumulated junk, HaulKind provides fast and affordable pickup services throughout Camden and surrounding areas.',
  ...
  },
  {
    ...
    slug: 'cherry-hill-nj',
    population: '74,000',
    description: 'Cherry Hill is one of the most desirable suburban communities in South Jersey, known for its excellent schools and family-friendly neighborhoods. Homeowners here regularly need help with seasonal cleanouts, furniture removal after upgrades, and efficient junk hauling that respects their property and schedule.',
  ...
  },
  {
    ...
    slug: 'trenton-nj',
    population: '90,000',
    description: 'As the capital of New Jersey, Trenton is a city with deep roots and a growing demand for professional hauling services. From government buildings to residential neighborhoods, Trenton residents and property managers need dependable junk removal, cleanout, and moving help at fair prices.',
  ...
  },
  {
    ...
    slug: 'princeton-nj',
    population: '31,000',
    description: 'Home to one of the world\'s most prestigious universities, Princeton combines academic prestige with charming small-town living. Residents, students moving out, and local businesses frequently need professional junk removal and moving help that is punctual, clean, and reasonably priced.',
  ...
  },
  {
    ...
    population: '43,000',
    description: 'Mount Laurel is a thriving Burlington County township known for its mix of residential communities and commercial centers along Route 73. Families and businesses here rely on efficient junk removal and hauling services for everything from garage cleanouts to office furniture disposal.',
...
export const SERVICES: ServiceData[] = [
  {
    ...
    priceRange: '$109 - $529',
    priceNote: 'Based on truck volume. 1/8 truck starts at $109.',
  },
  {
  ...
  },
  {
    ...
    priceRange: '$109 - $249',
    priceNote: 'Single couch starts at $109. Sectionals and multiples may cost more.',
  },
  {
    ...
    priceRange: '$109 - $199',
    priceNote: 'Single mattress removal starts at $109.',
  },
  {
    ...
    priceRange: '$109 - $349',
    priceNote: 'Single appliance starts at $109. Multiple appliances get volume pricing.',
  },
  {
  ...
  },
  {
    ...
    priceRange: '$109 - $349',
    priceNote: 'Pricing similar to junk removal. Donation routing at no extra charge.',
  },
]
