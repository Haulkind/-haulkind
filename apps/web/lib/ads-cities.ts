...
export const ADS_CITIES: AdsCityData[] = [
  // Pennsylvania
  {
    ...
    metaDescription: 'Book junk removal in Philadelphia starting at $109. Same-day pickup, live GPS tracking, no hidden fees. Serving all Philly neighborhoods.',
    subtitle: 'Transparent pricing starting at $109. Same-day pickup across all Philadelphia neighborhoods. Book online in 60 seconds.',
  ...
  },
  {
    ...
    metaDescription: 'Professional junk removal in Bucks County PA. Furniture, appliances, yard waste — we haul it all. Starting at $109.',
    subtitle: 'Serving Doylestown, Newtown, Langhorne, Levittown and all of Bucks County. Starting at $109.',
  ...
  },
  {
    ...
    metaDescription: 'Junk removal in Montgomery County PA starting at $109. Same-day available. King of Prussia, Norristown, Conshohocken and more.',
  ...
  },
  {
    ...
    metaDescription: 'Book junk removal in Delaware County PA. Media, Springfield, Upper Darby and all Delco towns. Starting at $109.',
    subtitle: 'Media, Springfield, Upper Darby, Havertown — all of Delco covered. Starting at $109.',
  ...
  // New Jersey
  {
    ...
    metaDescription: 'Junk removal across South Jersey. Camden, Cherry Hill, Voorhees, Marlton and more. Starting at $109. Book online now.',
    subtitle: 'Camden, Cherry Hill, Voorhees, Marlton, Mount Laurel and beyond. Starting at $109.',
  ...
  },
  {
    ...
    metaDescription: 'Professional junk removal in Trenton NJ. Furniture, appliances, cleanouts. Starting at $109. Same-day and next-day available.',
  ...
  },
  {
    ...
    metaDescription: 'Junk removal in Princeton NJ. Furniture, appliances, garage cleanouts. Starting at $109. Live driver tracking.',
  ...
  // NYC Boroughs
  {
    ...
    metaDescription: 'Fast junk removal in Brooklyn NY. Furniture, appliances, apartment cleanouts. Starting at $109. Book in 60 seconds.',
  ...
  },
  {
    ...
    metaDescription: 'Junk removal in Queens NY starting at $109. Astoria, Flushing, Jamaica and all neighborhoods. Same-day pickup.',
    subtitle: 'Astoria, Flushing, Jamaica, Long Island City and every corner of Queens. Starting at $109.',
  ...
  },
  {
    ...
    metaDescription: 'Professional junk removal in the Bronx. Furniture, appliances, cleanouts. Starting at $109. Track your driver live.',
  ...
  },
  {
    ...
    metaDescription: 'Junk removal in Staten Island starting at $109. Furniture, appliances, yard waste. Same-day available. No hidden fees.',
  ...
  },
  {
    ...
    metaDescription: 'Fast junk removal in Manhattan. Apartment cleanouts, furniture, appliances. Starting at $109. Book in 60 seconds.',
  ...
  // NYC Suburbs
  {
    ...
    metaDescription: 'Junk removal across Long Island — Nassau and Suffolk County. Furniture, appliances, yard waste. Starting at $109.',
    subtitle: 'Nassau County, Suffolk County — Hempstead to Montauk. Starting at $109.',
  ...
  },
  {
    ...
    metaDescription: 'Junk removal in Westchester County. White Plains, Yonkers, New Rochelle and more. Starting at $109.',
  ...
  },
  {
    ...
    metaDescription: 'Fast junk removal in Jersey City NJ. Furniture, appliances, apartment cleanouts. Starting at $109. No hidden fees.',
    subtitle: 'Downtown, the Heights, Journal Square and all of Jersey City. Starting at $109.',
  ...
  },
  {
    ...
    metaDescription: 'Junk removal in Newark NJ starting at $109. Same-day available. Professional, insured crews. Book online.',
  ...
  },
  {
    ...
    metaDescription: 'Junk removal in Hoboken NJ. Apartment cleanouts, furniture, appliances. Starting at $109. Book in 60 seconds.',
    subtitle: 'Apartment cleanouts and furniture removal across Hoboken. Starting at $109.',
