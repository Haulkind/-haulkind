  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.progressContainer}>
        ...
        <Text style={styles.progressText}>Step {currentStep - 1} of 2</Text>
      </View>
              ...
              <View style={styles.section}>
                ...
                >
                  ...
                  <View style={[styles.checkbox, canHaulAway && styles.checkboxActive]}>
                    {canHaulAway && <Text style={styles.checkmark}>✓</Text>}
                  </View>
                </TouchableOpacity>
                ...
                >
                  ...
                  <View style={[styles.checkbox, canLaborOnly && styles.checkboxActive]}>
                    {canLaborOnly && <Text style={styles.checkmark}>✓</Text>}
                  </View>
                </TouchableOpacity>
              </View>
            </View>
            ...
            <View style={styles.form}>
              ...
              <View style={styles.note}>
                <Text style={styles.noteText}>
                  🔒 Your documents are securely stored and will be reviewed within 24 hours.
                </Text>
              </View>
            </View>
          </View>
