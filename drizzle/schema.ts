...
/** * Haulkind Platform Database Schema * Complete schema for junk removal and labor marketplace */// ============================================================================// CORE USER TABLES// ============================================================================export const users = mysqlTable("users",
  {
...
export const customers = mysqlTable("customers",
  ...
  defaultPaymentMethodId: varchar("defaultPaymentMethodId",
  {
  length: 255
}),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
...
export const drivers = mysqlTable("drivers",
  ...
  ["pending",
  "approved",
  "blocked"]).default("pending").notNull(),
  isOnline: boolean("isOnline").default(false).notNull(),
  vehicleType: varchar("vehicleType",
  {
  length: 50
}),
  vehicleCapacity: decimal("vehicleCapacity",
  {
  precision: 10,
  scale: 2
}),
  ...
  acceptanceRate: decimal("acceptanceRate",
  {
  precision: 5,
  scale: 2
}).default("0").notNull(),
  cancelRate: decimal("cancelRate",
  {
  precision: 5,
  scale: 2
}).default("0").notNull(),
